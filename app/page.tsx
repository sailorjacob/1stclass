...
export default function HomePage() {
  ...
  const galleryImages = [
    ...
    {
      src: "https://kglfdycu0s7oxsz8.public.blob.vercel-storage.com/studios/TERMINALB-DoKqrOW8t2hmLEbZ5t5eXHBLLcORlb.avif",
      title: "TERMINAL B",
      ...
      <section className="relative min-h-screen pt-32">
        <div className="container mx-auto px-8">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-32 justify-items-center"
          >
